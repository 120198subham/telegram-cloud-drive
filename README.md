...
├── config.py             # Environment variables, 2 GB limit, directory paths
├── database.py           # SQLite asynchronous catalog (cloud_storage.db)
├── telegram_client.py    # Telethon MTProto client (upload, stream download, message delete)
├── main.py               # FastAPI server & streaming REST endpoints
